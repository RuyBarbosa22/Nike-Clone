  ...
  return (
    <section
      ...
      <div className="relative flex-1 flex max-sm:flex-col justify-center items-center xl:min-h-screen max-sm:pt-16 max-md:pt-20 max-lg:pt-20 max-xl:pt-20 bg-cover bg-center z-0">
        ...
        <div className="flex gap-4 sm:absolute max-sm:grid max-sm:grid-cols-2 max-md:grid-cols-3 sm:top-[100%] md:top-[90%] lg:top-[90%] xl:top-[85%] -bottom-[14%] xl:right-[6%] 2xl:right-[0%] pt-24">
